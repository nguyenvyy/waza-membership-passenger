...
describe('US38 get user info by id', () => {
    it('getUserInfoAPI_UTCID01', () => {
        ...
        return getUserInfoAPI('5dcd4221d1fc286fcb7a32ec', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI1ZGNkNDIyMWQxZmMyODZmY2I3YTMyZWMiLCJpYXQiOjE1NzU1NTQ0MDd9.DQ4cIoJ3zw5ClhrcvhU7fCVqT__MWTtoPSy8zjBiuEg')
            .then(res => {
                expect(res.data).toBeDefined()
                expect(res.data).toEqual(expectData)
            })
    })
    it('getUserInfoAPI_UTCID02', () => {
